...
func _ready():
	...
	match size:
		AsteroidSize.LARGE:
			...
			cshape.set_deferred("shape",preload("res://Lelvels/Chapter1/Lvl1/resourses/asteroidBig.tres"))
		AsteroidSize.MEDIUM:
			speed = 150
			sprite.texture=preload("res://assets/meteorBrown_small1.png")
			cshape.set_deferred("shape",preload("res://Lelvels/Chapter1/Lvl1/resourses/asteroidMed.tres"))		
		AsteroidSize.SMALL:
			speed = 200
			sprite.texture=preload("res://assets/meteorGrey_tiny1.png")
			cshape.set_deferred("shape",preload("res://Lelvels/Chapter1/Lvl1/resourses/asteroidTiny.tres"))
